(function() {
    ...
    new FullCalendar.Draggable(l, {
        itemSelector: ".fc-event",
        eventData: function(r) {
            return {
                title: r.innerText.trim(),
                title: r.innerText,
                className: r.className + " overflow-hidden ",
            };
        },
    });
    var c = document.getElementById("calendar2"),
        n = new FullCalendar.Calendar(c, {
            headerToolbar: {
            ...
            editable: !0,
            dayMaxEvents: !0,
            eventSources: [o, d, s, i],
        });
    n.render();
    var u = document.getElementById("full-calendar-activity");
    new SimpleBar(u, { autoHide: !0 });
})();