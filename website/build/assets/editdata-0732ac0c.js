(function () {
  var e = [
    ...
    a = new Tabulator("#validation-table", {
      width: 100,
      minWidth: 40,
      layout: "fitColumns",
      pagination: "local",
      ...
      columns: [
        ...
        },
        {
          ...
          field: "age",
          editor: "input",
          validator: ["min:20", "max:50", "integer"],
        },
        {
          title: "Salary",
          field: "salary",
          editor: "input",
          validator: ["min:100000", "max:1500000", "integer"],
        },
      ],
    });
  a.on("validationFailed", function (i, t, o) {});
})();
